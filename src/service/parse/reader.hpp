...
inline char reader::get_if_satisfy (bool (*predicate)(char))
{
    char c = get_char();
...
inline char reader::eat_if_satisfy (bool (*predicate)(char))
{
    char c = get_char();
    if (predicate(c)) { return eat_char(); }

    return 0;
}


inline void reader::skip_if_satisfy (bool (*predicate)(char))
{
    eat_if_satisfy(predicate);
}
