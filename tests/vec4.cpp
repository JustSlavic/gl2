...
TEST(Vector4, Operations) {
    ...
    EXPECT_EQ(-v, math::vector4::make(-1.f, -2.f, -3.f, -4.f));
    EXPECT_EQ(v + w, math::vector4::make(4.f, 6.f, 8.f, 10.f));
    EXPECT_EQ(v - w, math::vector4::make(-2.f, -2.f, -2.f, -2.f));
    EXPECT_EQ(2.f * v, math::vector4::make(2.f, 4.f, 6.f, 8.f));
    EXPECT_EQ(3.f * w, math::vector4::make(9.f, 12.f, 15.f, 18.f));

    v += w;
    EXPECT_EQ(v, math::vector4::make(4.f, 6.f, 8.f, 10.f));

    v *= 5.f;
    EXPECT_EQ(v, math::vector4::make(20.f, 30.f, 40.f, 50.f));
